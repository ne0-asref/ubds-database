...
`dbf` is the reference implementation of UBDS v1.2. Use it to lint board YAML
...
| Command | Purpose |
|---|---|
| `dbf validate` | Lint a UBDS YAML file against schema v1.2 |
